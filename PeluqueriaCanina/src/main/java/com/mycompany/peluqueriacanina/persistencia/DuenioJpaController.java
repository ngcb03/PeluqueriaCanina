...
public class DuenioJpaController implements Serializable {
    ...
    private DuenioJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
...
// Implementamos patrón singleton
    ...
    private static DuenioJpaController duenioJpa = null;

    private DuenioJpaController () {
        emf = Persistence.createEntityManagerFactory("peluCaninaPU");
    }
    
    public static DuenioJpaController getInstance(){
        if (duenioJpa == null){
            return (duenioJpa = new DuenioJpaController());
        }
        System.out.println("¡Ya existe una instancia para DuenioJpaController!");
        return null;
    }
