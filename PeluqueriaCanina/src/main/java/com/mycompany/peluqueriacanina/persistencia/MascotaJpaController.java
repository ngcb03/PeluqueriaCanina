...
public class MascotaJpaController implements Serializable {
    ...
    private MascotaJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
...
// Implementamos patrón singleton
    ...
    private static MascotaJpaController mascoJpa = null;
    
    private MascotaJpaController () {
        emf = Persistence.createEntityManagerFactory("peluCaninaPU");
    }
    
    public static MascotaJpaController getInstance(){
        if (mascoJpa == null){
            return (mascoJpa = new MascotaJpaController());
        }
        System.out.println("¡Ya existe una instancia para MascotaJpaController!");
        return null;
    }
