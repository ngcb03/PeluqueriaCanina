...
public class ClienteJpaController implements Serializable {
    ...
    private ClienteJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
...
// Implementamos patrón singleton
    ...
    private static ClienteJpaController clienteJpa = null;
    ...
    public static ClienteJpaController getInstance(){
        if (clienteJpa == null){
            return (clienteJpa = new ClienteJpaController());
        }
        System.out.println("¡Ya existe una instancia para ClienteJpaController!");
        return null;
    }
