...
public class RegistroClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGuadar.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
    ...
    private void btnGuadarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuadarActionPerformed
        ...
        if(duenio.isEmpty() || celDuenio.isEmpty() || mascota.isEmpty() || 
            ...
            RegistroClientes.mensajeEmergente("¡Operación incorrecta!", "error", "¡Faltan campos por llenar!");
            
        } else {
            Controladora.getInstance().crearCliente(duenio, celDuenio, mascota, raza, color, alergico, atEspecial, observaciones);
            mensajeEmergente("¡Operación exitosa!", "info", "¡El cliente a sido registrado correctamente!");
            limpiarCampos();
        }
